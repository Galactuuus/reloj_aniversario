...
void loop() {
    ...
    if(contadorhora >= 0 && contadorhora < 7){
...
void texto(){
    ...
    int long contadordiames = array_diasmeses[ahora2.month() - 2] - elmejordia2.day() + ahora2.day();
    int long contadormes = (ahora2.year() - elmejordia2.year()) * 12 + (ahora2.month() - elmejordia2.month() - 1);
